    ...
    <body>
        ...
        <div class="hidden lg:block lg:w-1/5 bg-green-700">
            ...
            <div class="flex flex-col" style="height: 100%;">
                <a href="" class="p-4 pl-5 flex items-center hover:bg-green-900 @yield('home')">
                ...
                <a href="" class="p-4 pl-5 flex items-center hover:bg-green-900 @yield('blogs')">
                    <div class="bg-white h-10 w-10 rounded-full text-green-600 p-2 mr-4">
                ...
                <a href="" class="p-4 pl-5 flex items-center hover:bg-green-900 @yield('messages')">
                    <div class="bg-white h-10 w-10 rounded-full text-green-600 p-2 mr-4">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <a href="" class="p-4 pl-5 flex items-center hover:bg-green-900 @yield('events')">
                    <div class="bg-white h-10 w-10 rounded-full text-green-600 p-2 mr-4">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <a href="" class="p-4 pl-5 flex items-center hover:bg-green-900 @yield('places')">
                    <div class="bg-white h-10 w-10 rounded-full text-green-600 p-2 mr-4">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 20l-5.447-2.724A1 1 0 013 16.382V5.618a1 1 0 011.447-.894L9 7m0 13l6-3m-6 3V7m6 10l4.553 2.276A1 1 0 0021 18.382V7.618a1 1 0 00-.553-.894L15 4m0 13V4m0 0L9 7" />
                        </svg>
                ...
                <a href="" class="p-4 pl-5 flex items-center hover:bg-green-900 @yield('reports')">
                    <div class="bg-white h-10 w-10 rounded-full text-green-600 p-2 mr-4">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
